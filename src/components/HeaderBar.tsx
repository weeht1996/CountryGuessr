...
const HeaderBar = ({startNewGame, allRecords, guideModalToggle, setGuideModal}: HeaderBarProps) => {
    ...
    return (
        <div className="flex justify-center items-center gap-2 mb-12 text-slate-300">
            <span className="h-7 w-7 border-2 hover:animate-spin bg-slate-300 text-black hover:bg-slate-500 hover:border-slate-500 cursor-pointer rounded-full flex items-center justify-center mt-1 "
            ...
            <span className="hover:text-slate-500 cursor-pointer" onClick={() => setGuideModal(true)} title="Guide">
                <svg width="32px" height="32px" viewBox="0 -1 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
