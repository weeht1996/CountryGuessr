      ...
      <label className="mr-4 font-extrabold text-slate-400">{hintLabel}:</label>
      {
        isImage ? (
          isHintRevealed || isAnswerRevealed ? ( //image
            ...
            <div
              className="flex justify-center w-full min-w-[220px] min-h-[130px] mr-4 rounded-md bg-slate-700 hover:bg-slate-600 cursor-pointer"
          ...
          <div
            className="flex justify-center h-auto w-[200px] p-1 rounded-md bg-slate-700 hover:bg-slate-600 cursor-pointer"
            onClick={() => overlayClicked()}
          >
            <div className="flex items-center text-clamp">
              Reveal
  ...
  return (
    <div className="flex flex-col rounded-md relative ">
      ...
      </div>
      {
        ...
        >
          <div
            className={`flex flex-wrap relative justify-between items-center mb-2 ${currentState.guessed || currentState.gaveUp ? "w-5/12" : "w-full"}`}
          >
            {!currentState.guessed && !currentState.gaveUp && (
            ...
            <div
              className={
                currentState.guessed
                  ? `mt-2 flex flex-col justify-start items-start`
    ...
    <div className="card-body w-full lg:w-[1152px] flex flex-col item-center bg-slate-900 border border-slate-800 rounded-lg text-clamp">
      {cardStates.length === 0 ? (
        <div>
          <button
            type="button"
            className="w-full inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-slate-700 hover:bg-slate-600 transition ease-in-out duration-150 cursor-not-allowed"
            disabled
          >
            <svg
